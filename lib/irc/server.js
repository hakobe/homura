    ...
    if (options.tls) {
        ...
        this.server = tls.createServer(
            ...
            (function( cleartextStream ) {
                console.dir(cleartextStream);
                if (cleartextStream.authorized) {
                    Log.debug('<irc.Server> This connection is authorized');
                }
                else {
                    Log.debug('<irc.Server> This connection is NOT authorized : ' + cleartextStream.authorizationError);
                }
