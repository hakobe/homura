...
var nameToNum = {};
Object.keys( numToName ).forEach( function( num ) {
    var name = numToName[num];
    nameToNum[ name ] = num;
});

exports.nameFor = function(num)  { return numToName[ num ]; };
exports.numFor  = function(name) { return nameToNum[ name ]; };
