...
function Session(connection) {
    ...
    this.connection.on('end', function() {
        Log.debug("<irc.Session> connection end");
    });
    this.connection.on('close', (function() {
        Log.debug("<irc.Session> connection closed");
        this.emit('close');
    }).bind(this));
    this.connection.on('error', function() {
        Log.debug("<irc.Session> network error: " + message.toRaw());
    });
...
Session.prototype.updatePrefix = function() {
    this.prefix = this.nick + '!' + this.user + '@' + this.host;
};
